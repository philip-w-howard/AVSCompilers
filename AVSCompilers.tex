...
Compiler front-ends typically contain two components: A scanner (or tokenizer or lexer), and a parser. Scanners are discussed in Part~\ref{part.scanner} and parsers are discussed in Part~\ref{part.parser}.
