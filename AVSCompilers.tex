...
\begin{mydesc}[10em]
  ...
  \item[Alternation] Alternation means to choose exactly one from a set of alternatives. Regular expressions use the vertical bar (\code{|}) to mean alternation. So the expression \code{a | b | c} means to choose either an '\code{a}', a '\code{b}', or a '\code{c}'.
